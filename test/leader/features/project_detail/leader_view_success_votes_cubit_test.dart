...
void main() {
  ...
  test('load uses GET /projects/{id} voting when Week 11 envelope is active', () async {
  ...
  test('load falls back to active vote for legacy detail without voting envelope', () async {
  ...
  test('canFinalize when GL and deadline passed', () async {
    ...
    when(
      ...
      (_) async => Right(
        ...
        projectWithVoting(deadlineAtUtc: DateTime.utc(2020, 1, 1)),
  ...
  test('canFinalize when GL and votingStatus done', () async {
    ...
    when(
      ...
      (_) async => Right(
        ...
        projectWithVoting(
          ...
          deadlineAtUtc: DateTime.utc(2020, 1, 1),
