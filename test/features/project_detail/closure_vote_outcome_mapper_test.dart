...
void main() {
  ...
  group('successVoteOutcomeRouteArgsFromProjectDetail', () {
    test('uses API tallies from voting envelope', () {
      final project = ProjectDetailEntity(
        ...
        voting: ProjectVotingSummaryEntity(
          ...
          deadlineAtUtc: DateTime.utc(2026, 1, 8),
          agreedCount: 6,
          disagreedCount: 1,
          pendingCount: 0,
          isFinalized: true,
      ...
      final args = successVoteOutcomeRouteArgsFromProjectDetail(project);

      expect(args.data.isApproved, isTrue);
      expect(args.data.agreedCount, 6);
      expect(args.data.disagreedCount, 1);
