...
class AppColors {
  ...
  static const Color authSubtitle =
      grey800; // #5E5783 — medium body under title
  static const Color authLabel = grey900; // #443F63
  /// Create project settings labels — Repayment window, Penalty, etc.
  static const Color createProjectSettingsLabel = grey900;
