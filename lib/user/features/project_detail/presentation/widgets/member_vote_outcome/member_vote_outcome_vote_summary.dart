...
/// “Vote Summary” + agreed / disagreed rows (Figma vote outcome).
class MemberVoteOutcomeVoteSummary extends StatelessWidget {
  final MemberVoteOutcomeUiData data;

  const MemberVoteOutcomeVoteSummary({super.key, required this.data});

  @override
  Widget build(BuildContext context) {
    final rows = data.isApproved
        ? [
            _VoteRow.agreed(data),
            SizedBox(height: 10.h),
            _VoteRow.disagreed(data),
          ]
        : [
            _VoteRow.disagreed(data),
            SizedBox(height: 10.h),
...
class _VoteRow extends StatelessWidget {
  ...
  factory _VoteRow.agreed(MemberVoteOutcomeUiData data) {
    return _VoteRow(
  ...
  factory _VoteRow.disagreed(MemberVoteOutcomeUiData data) {
    return _VoteRow(
