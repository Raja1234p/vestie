...
/// Leader pill on project member rows — Figma Action/Information spec.
class ProjectMemberLeaderBadge extends StatelessWidget {
  const ProjectMemberLeaderBadge({super.key});
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          ...
          colors: [
            AppColors.actionInformationBorderLight,
            AppColors.actionInformationBorderDark,
          ],
        ),
      ),
        ...
        child: Stack(
          children: [
            Positioned.fill(
              child: DecoratedBox(
                decoration: BoxDecoration(
                  color: AppColors.actionInformationPressed,
                ),
              ),
            ),
            Positioned.fill(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  AppText(
                    AppStrings.projectMemberLeaderBadge,
