...
/// Shared purple Action/Primary pill — VFF and Top Contributor (same icon + style).
class ProjectMemberPrimaryPillBadge extends StatelessWidget {
  final String label;

  const ProjectMemberPrimaryPillBadge({super.key, required this.label});
