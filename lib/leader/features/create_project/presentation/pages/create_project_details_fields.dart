...
String _creationFlowCardTitle(ProjectCreationFlowType f) => switch (f) {
      ProjectCreationFlowType.collaborativeSaving => AppStrings.flowSavingTitle,
      ProjectCreationFlowType.fundsBorrowing => AppStrings.flowBorrowingTitle,
      ProjectCreationFlowType.streamlined => AppStrings.flowSimpleTitle,
    };

String _creationFlowCardSubtitle(ProjectCreationFlowType f) => switch (f) {
      ProjectCreationFlowType.collaborativeSaving => AppStrings.flowSavingSubtitle,
      ProjectCreationFlowType.fundsBorrowing => AppStrings.flowBorrowingSubtitle,
      ProjectCreationFlowType.streamlined => AppStrings.flowSimpleSubtitle,
    };

String _creationFlowCardGlyph(ProjectCreationFlowType f) => switch (f) {
      ProjectCreationFlowType.collaborativeSaving =>
        AppAssets.iconEmergencyFund,
      ProjectCreationFlowType.fundsBorrowing =>
        AppAssets.iconDollarCircle,
      ProjectCreationFlowType.streamlined => AppAssets.iconList,
    };

/// Picks which of the three product flows follows Project Details (saving vs borrowing vs simple).
class CPCreationFlowPicker extends StatelessWidget {
  final ProjectCreationFlowType value;
  final ValueChanged<ProjectCreationFlowType> onChanged;

  const CPCreationFlowPicker({
    super.key,
    required this.value,
  ...
  Widget build(BuildContext context) {
    return Column(
      children: ProjectCreationFlowType.values.map((option) {
            ...
            child: InkWell(
              ...
              child: AnimatedContainer(
                ...
                child: Row(
                  children: [
                    AppSvgIcon(
                      assetPath: _creationFlowCardGlyph(option),
                      size: 22.w,
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 2.h),
                          Text(
                            _creationFlowCardSubtitle(option),
                            style: GoogleFonts.lato(
                              fontSize: 11.sp,
                              height: 1.35,
